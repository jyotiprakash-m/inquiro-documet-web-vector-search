...
export async function POST(request: NextRequest) {
  try {
    ...
    const document = await prisma.batchResource.findUnique({
    ...
    // Combine all vectors from documents and web pages
    const allVectors = [
      ...document.documents.flatMap((doc) => doc.vectors),
      ...document.webPages.flatMap((page) => page.vectors),
    ];
